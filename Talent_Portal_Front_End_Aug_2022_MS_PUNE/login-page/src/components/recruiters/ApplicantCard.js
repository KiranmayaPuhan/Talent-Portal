...
function ApplicantCard({ u }) {
  ...
  useEffect(() => {
    axios.get(`http://localhost:12000/api/UserSkill/userid?userid=${u.userId}`, {
        headers:{
  ...
  return (
    <>
      <div className="mt-3 c-card bg-white" key={u.userId}>
              ...
              <tr className="applicantgrid">
                ...
                <td>
                  ...
                  <a href={appStatus.resume} target="_blank">
                    <Button className="btn-light btn-outline-primary text-center">
                    {/* <GrView/> */} View Resume
                  </Button>
                  </a>
                {/* <td>
