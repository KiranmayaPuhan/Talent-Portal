...
console.log("skillData",data);
    ...
    return(
        ...
        <div className="container">
          <div className="c-card mt-3 p-5 bg-white">
                      ...
                      <tbody>
                        {
                          jobSkills.map((js)=>(
                            <tr key={js.jobSkillId}>
                              ...
                              <td><button className="btn-primary btn-sm ms-1" onClick={()=>{{deleteSkillHandler(js.skillId)}}} > Remove </button></td>
