...
export default function JobDetails(){ 
    ...
    return(
      ...
      <>
            <br /><br />
            <div className="job-post-company pt-120 pb-120 card-mt-3 c-card " > 
            <div className="card-body shadow-lg opacity-100 bg-white ">
                    ...
                    <div className="row justify-content-between">
                        ...
                        <div className="single-job-items mb-50">
                            ...
                            <div className="job-tittle">
                                ...
                                <h2 style={{color:"Highlight", fontWeight:"bold"}}>{jobTable.jobName}</h2>
                                
                                <ul>
                                {/* <li>Creative Agency</li> */}
                                
                                <IoLocationSharp size={18}/> {jobTable.jobLocation}
                                <br />
                                <TbCurrencyRupee size={20}/> {jobTable.minPackage} - {jobTable.maxPackage} LPA
                                <br />
                                <BiBriefcase size={20} /> {jobTable.minExp} Years (Min Exp)
                                </ul>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="job-post-details">
                            <div className="post-details1 mb-50" style={{whiteSpace:"pre-wrap"}}>
                            {/* Small Section Tittle */}
                            <br />
                            <div className="small-section-tittle">
                                <h4 style={{fontWeight:"bold"}}>Job Description</h4>
                            </div>
                            <p>
                               
                                {jobTable.jobDescription}
                            </p>
                            </div>
                            ...
                            <br />
                            <div className="small-section-tittle">
                                <h4 style={{fontWeight:"bold"}}>Skills Required</h4>
                                <ul>
                                  {
                                    skillTable?.length > 0
                                      ?(
                        ...
                        <div className="post-details3  mb-50 " style={{paddingLeft:"20px", paddingBottom:"20px",outlineStyle:"dashed",outlineWidth:"1px" ,outlineColor:"grey", marginTop:"20px", marginRight:"15px", marginBottom:"20px"}}>
                            {/* Small Section Tittle */}
                            <div className="small-section-tittle" >
                                <br />
                            <h4 style={{fontWeight:"bold"}}>Job Overview</h4>
                            </div>
                            <ul>
                            <li>
                                Posted date : <span>{Moment(jobTable.jobPostDate).format("MMM Do YYYY")}</span>
                            </li>
                            <li>
                                Location : <span>{jobTable.jobLocation}</span>
                            </li>
                            <li>
                                Vacancy : <span>{jobTable.openings}</span>
                            </li>
                            <li>
                                Job nature : <span>{jobTable.jobType}</span>
                            </li>
                            <li>
                                Salary : <span>{jobTable.minPackage} - {jobTable.maxPackage} LPA</span>
                            </li>
                            {/* <li>
