        ...
        <section>
          ...
          <div className="row mt-5 ">
            <div className="col-md-6 mx-auto">
              <h5 style={{color:"indigo"}}>Employer Profile</h5>
              ...
              <br/>
              <div className="row">
              <Button variant="info" type="button" className="btn-light btn-outline-success btn-sm me-5" onClick={() => navigate(`/addjob`)} >  
                                        Add a Job
               </Button>
               </div>
               <div className="row">
              ...
              <div className="row">
              <Button variant="info" type="button" className="btn-light offset-md-6 btn-outline-info btn-sm ms-auto" onClick={() => navigate(`/recruiter`)} >  
                                        View posted jobs
               </Button>
              </div>
