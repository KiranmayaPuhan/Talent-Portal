...
import {ModalHeader, Modal} from "react-bootstrap";
...
export default function Login() {
	...
	const closeModalHandler = () => {
		setTimeout(() => {
			setShowModal(false)
			if(JSON.parse(sessionStorage.getItem("Job ID"))) { 
    ...
    const LoginUser = () => {
        ...
        .then((response) => {
			...
			console.log(error)
            setLoginState("Login unsuccessful! Check your credentials.")
    ...
    return ( 
        ...
        <pre className="col-sm-12 mb-3 text-center" style={{color:"red"}}>{loginState}</pre>
			<div className="row justify-content-sm-center h-100">
				<div className="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					<div className="card shadow-lg">
						<div className="card-body p-5">
							<h1 className="fs-4 card-title fw-bold mb-4 text_heading" style={{textAlign:"center",color:"indigo"}}>Login</h1>
