            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-7 col-sm-9">
              <div className="card shadow-lg">
                <div className="card-body p-4">
                  <h1 className="fs-4 card-title fw-bold mb-4 text_heading" style={{color:"indigo"}}>Register User</h1>
                  <form method="POST" className="needs-validation" noValidate autoComplete="off">
                   ...
                   <div className="row">
                    <div className="col-md-6 mb-3">
                      ...
                      <input id="dob" type="date" className="form-control form-control-sm" name="dob" required placeholder="Select your date of Birth" ref={userDOB} onChange={() => setUserDOBCheck(true)} max={eighteenYearsAgo}/>
                      <div className="invalid-feedback">
